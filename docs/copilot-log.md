...
**Task:** Repo scaffolding + Iteration 1 discovery prototype (dumpbin exports → CSV)
...
**Manual Edits:**
- Added tiered output logic (5 levels)
- Enhanced header file parser with prototype regex
- Implemented Doxygen comment extraction
- Added demangling support via undname.exe

**Result:** Generated example CSV artifact for libzstd; documented run command in README/lab-notes

**References:**
- Visual Studio "x64 Native Tools Command Prompt" requirement for dumpbin.exe availability
- Microsoft Learn/VS docs for VC tools environment (dumpbin/undname availability)
